...
```javascript
import iterNonSquaresSeq from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-sequences-nonsquares@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-sequences-nonsquares/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/math-iter-sequences-nonsquares/actions/workflows/test.yml?query=branch:v0.2.3
